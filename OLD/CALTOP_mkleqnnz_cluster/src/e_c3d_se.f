...
!     expand vl(i,j) into uelem vector of size 3*nope
      l=0
      do j=1,nope
         do k=1,3
            l=l+1
...
!
c         write(200,*) kk, xsj,xi,et,ze,weight
         elvol=elvol+weight*xsj
...
!              Calculating element volume on dimension only
!
...
!!               if((rhsi.eq.1).and.(idist.eq.1)) then
 !!                 do i=1,3*nope
 !!                    dfl(idesloc,i)=(ff(i)-ff0(i))/distmin
!!                  enddo
 !!              else
!!                  do i=1,3*nope
 !!                    dfl(idesloc,i)=0.d0
...
!!               if((rhsi.eq.1).and.(idist.eq.1)) then
!!                  do i=1,3*nope
!!                     dfl(idesloc,i)=(ff(i)-ff0(i)-dfl(idesloc,i))
!!     &                    /distmin
!!                  enddo
!!               else
!!                  do i=1,3*nope
