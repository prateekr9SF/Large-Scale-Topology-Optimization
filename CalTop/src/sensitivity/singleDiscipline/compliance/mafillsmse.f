...
c      write(*,*) penal
c      open (unit=100,file="COMPLIANCE.dat")
c      open (unit=10,file="SENSITIVITIES.dat")
c      open (unit=200,file="CGmafillsmse.dat")
!     
...
!               Compliance + sensitivity for large deformation
!               call flush(6)
...
!
     ...
     &            rhoi,'sensi=',sensi
            ...
            elCG(2,i)=ycg
            elCG(3,i)=zcg
            tcompli=tcompli+ecompli
            gradCompl(i)=sensi
c            write(100,*) i,rhoi
c            write(10,*) i,sensi,elvol
c            write(200,*) i,elCG(1,i),elCG(2,i),elCG(3,i)
